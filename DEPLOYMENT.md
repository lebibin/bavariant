...
sudo service unicorn_bavariant <start|stop|restart>
sudo service sidekiq_bavariant <start|stop>
```
...
```
/home/deployer/apps/bavariant/shared/.env.production
```

After making changes to this file, be sure to restart the application:

```
sudo service unicorn_bavariant restart
sudo service sidekiq_bavariant stop
sudo service sidekiq_bavariant start
```
